...
public class Car {
	...
	public static void main(String[] args) {
		...
		System.out.println(anOwner.getFirstName() + " " + anOwner.getLastName()
				+ " drives a " + aCar.getColor() + " " + aCar.getYear() + " "
		...
		System.out.println("The owner's name was gathered from the car bean: "
				+ aCar.getOwner().getFirstName() + " "
				+ aCar.getOwner().getLastName());
		...
		System.out.println("Someday, " + aCar.getOwner().getFirstName()
				+ " will drive a " + aCar.getColor().toLowerCase() + " "
				+ aCar.getYear() + " " + aCar.getMake() + " " + aCar.getModel()
				+ ".");
		...
		System.out.println(aCar.getOwner().getFirstName() + " "
				+ aCar.getOwner().getLastName() + " drives a model year "
				+ aCar.getYear() + " " + aCar.getMake() + " " + aCar.getModel()
				+ ", the color of which is " + aCar.getColor() + ".");

		// Can I change the information through the car bean? If so, I probably
		// want to fix that.
		aCar.getOwner().setFirstName("Johnny");
		aCar.getOwner().setLastName("Appleseed");

		// Print from the car bean
		System.out.println("The new owner is: "
				+ aCar.getOwner().getFirstName() + " "
				+ aCar.getOwner().getLastName());
